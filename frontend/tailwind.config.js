  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "yarn-roll": "yarn-roll 4s ease-in-out infinite",
        "lazy-cat": "lazy-cat 3s ease-in-out infinite",
        "purr": "purr 1.5s ease-in-out infinite",
        "ear-twitch": "ear-twitch 3s ease-in-out infinite"
      },
      keyframes: {
        float: {
